...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $emailAutenticado = $_SESSION['Email'];
    if ($email !== $emailAutenticado) {
        $error_message = "O e-mail inserido não coincide com o e-mail do utilizador autenticado.";
    } else {
        ...
        if ($result->num_rows > 0) {
            ...
            $assuntoMsg = 'Second Life - Redefinir Senha';
